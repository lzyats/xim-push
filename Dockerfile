...
WORKDIR /data
RUN mkdir logs
#ADD target/alpaca-push.jar platform-admin.jar
ADD alpaca-push.jar platform-admin.jar
# 修改时区
...
# 运行jar包
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","/data/platform-admin.jar"]